    ...
    public partial class Fpsware
    {
        ...
        private PrioritySelector CreatePullBehavior()
        {
            return new PrioritySelector(
                ...
                new Action(ret=> Movement.MoveTo(Target.InteractRange-1))
        ...
        public class Charge : Action
        {
            protected override RunStatus Run(object context)
            {
                ...
                if (!Spell.IsOnCooldown("Charge")) return RunStatus.Failure;
                while (Target.IsDistanceMoreThan(Target.InteractRange)) { System.Threading.Thread.Sleep(150); }
