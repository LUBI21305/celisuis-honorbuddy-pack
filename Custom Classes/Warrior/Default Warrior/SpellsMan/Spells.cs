...
namespace Hera.SpellsMan
{
    public static class Spell
    {
        ...
        public static bool CastDebuff(string spellName)
        {
            ...
            Utils.Log(String.Format("{0} on {1}", spellName, Me.CurrentTarget.Class), Utils.Colour("Blue"));
            return true;
        }
        ...
        {
            Debug.Log(String.Format("CastDebuff {0} targetUnit {1}", spellName, targetUnit.Class), 1);
        ...
        {
            Debug.Log(String.Format("CastBuff {0} targetUnit {1}", spellName, targetUnit.Class), 1);
            if (targetUnit.HasAura(spellName)) return false;
            if (!CanCast(spellName)) return false;
