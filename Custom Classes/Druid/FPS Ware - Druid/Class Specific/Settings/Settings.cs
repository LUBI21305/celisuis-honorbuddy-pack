...
namespace Hera
{
    public static class Settings
    {
        ...
        public static string ConfigFolder
        {
            get
            {
                const string basePath = @"CustomClasses\Fpsware Druid\Class Specific\Settings\";
        ...
        public static string ConfigFile
        {
            get
            {
                const string basePath = @"CustomClasses\Fpsware Druid\Class Specific\Settings\Settings.xml";
        ...
        //public static string ConfigFile = @"CustomClasses\Fpsware Druid\Class Specific\Settings\Settings.xml";
