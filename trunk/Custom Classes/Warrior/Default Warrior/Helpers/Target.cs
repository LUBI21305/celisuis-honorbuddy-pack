...
namespace Hera.Helpers
{
    public static class Target
    {
        ...
        /// <summary>
        /// TRUE if you are behind your target
        /// </summary>
        public static bool IsBehind
        {
            ...
            {
                if (!Me.GotTarget) return false;
                return WoWMathHelper.IsBehind(Me.Location, CT.Location, CT.Rotation, (float)Math.PI);
            }
        }

        /// <summary>
        /// A WoWPoint 1 yard behind the target
        /// </summary>
        public static WoWPoint PointBehind
        {
            get
            {
                if (!Me.GotTarget) return null;
                return WoWMathHelper.CalculatePointBehind(CT.Location, CT.Rotation, 1);
            }
        }
        ...
        public static bool IsValidPullTarget
        {
            get
            {
                ...
                if (CT.IsFlying && !Me.IsFlying) return false;
